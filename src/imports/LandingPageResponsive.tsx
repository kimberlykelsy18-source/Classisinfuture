...
export default function LandingPage() {
  return (
    <div className="w-full bg-white">
      {/* Hero Section */}
      <section className="relative w-full px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-40 py-12 md:py-16 lg:py-20 overflow-hidden">
        <Component4 />
        <Component5 />
        
        <div className="relative z-10 max-w-[1488px] mx-auto text-center">
          <h1 className="font-['Afacad'] font-medium tracking-tight text-black mb-6 md:mb-8 lg:mb-10">
            <span className="block text-[clamp(2rem,5vw,5rem)] lg:text-[72px] leading-tight">Education 2040: What We Build Today,</span>
            <span className="block text-[clamp(2rem,5vw,5rem)] lg:text-[72px] leading-tight">They'll Inherit Tomorrow</span>
          </h1>
          
          <p className="font-['Afacad'] text-[clamp(1.125rem,2vw,2rem)] lg:text-[32px] text-black max-w-5xl mx-auto mb-10 md:mb-12 lg:mb-16 leading-relaxed lg:leading-[1.4]">
            A future-forward, moonshot-themed gathering where investors and founders debate long-term bets in education innovation.
          </p>
          
          <button className="bg-[#6923d2] text-white px-10 py-4 md:px-12 md:py-5 lg:px-16 lg:py-6 rounded-lg font-['Afacad'] font-medium text-[clamp(1.125rem,1.5vw,1.5rem)] lg:text-[24px] hover:bg-[#5a1db8] transition-colors shadow-lg inline-block">
            Get a ticket to Class is in Future 2026
          </button>
          
          <div className="mt-12 md:mt-16 lg:mt-20 w-full mx-auto rounded-2xl overflow-hidden shadow-2xl">
            <img src={imgFrame6} alt="Conference Hero" className="w-full h-auto object-cover" />
          </div>
        </div>
      </section>

      {/* Why Should You Attend Section */}
      <section className="w-full px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-40 py-12 md:py-16 lg:py-20">
        <div className="max-w-[1488px] mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="font-['Afacad'] font-medium text-[clamp(2.5rem,5vw,4.5rem)] lg:text-[72px] text-black tracking-tight mb-6 lg:mb-8">
              Why Should You Attend?
            </h2>
            <p className="font-['Afacad'] text-[clamp(1.125rem,2vw,2rem)] lg:text-[32px] text-black max-w-5xl mx-auto leading-relaxed lg:leading-[1.4]">
          ...
          {/* Our Audience Grid Banner */}
          <div className="bg-black rounded-lg py-5 md:py-6 lg:py-7 px-6 text-center mb-8 md:mb-10 lg:mb-12 overflow-hidden relative">
            <h3 className="font-['Afacad'] font-medium text-[clamp(1.25rem,2vw,1.75rem)] lg:text-[28px] text-white relative z-10">Our Audience Grid</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-10 lg:mb-12">
            {/* Educators Card */}
            <div className="bg-[#ffebf1] border-2 border-[#ff0056] rounded-2xl p-6 md:p-8 lg:p-10 relative overflow-hidden min-h-[300px] lg:min-h-[400px]">
              <div className="absolute right-4 top-4 w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 opacity-30">
              ...
              <h3 className="font-['Afacad'] font-medium text-[clamp(1.75rem,3vw,3.5rem)] lg:text-[56px] text-[#ff5c93] mb-4 lg:mb-6 leading-tight">
                Educators &<br />Researchers
              </h3>
              <p className="font-['Afacad'] text-[clamp(1rem,1.25vw,1.25rem)] lg:text-[20px] text-black leading-relaxed lg:leading-[1.6] max-w-[95%]">
            ...
            {/* Startups Card */}
            <div className="bg-[#f2faf0] border-2 border-[#356926] rounded-2xl p-6 md:p-8 lg:p-10 relative overflow-hidden min-h-[300px] lg:min-h-[400px]">
              <div className="absolute right-4 top-4 w-20 h-24 md:w-24 md:h-32 lg:w-28 lg:h-36 opacity-30">
              ...
              <h3 className="font-['Afacad'] font-medium text-[clamp(1.75rem,3vw,3.5rem)] lg:text-[56px] text-[#4f9d39] mb-4 lg:mb-6 leading-tight">
                Startups &<br />Entrepreneurs
              </h3>
              <p className="font-['Afacad'] text-[clamp(1rem,1.25vw,1.25rem)] lg:text-[20px] text-[#4f9d39] leading-relaxed lg:leading-[1.6] mt-12 lg:mt-20 max-w-[95%]">
            ...
            {/* Investors Card */}
            <div className="bg-[#f3eefc] border-2 border-[#6d24db] rounded-2xl p-6 md:p-8 lg:p-10 relative overflow-hidden min-h-[300px] lg:min-h-[400px]">
              <div className="absolute right-4 top-4 w-20 h-24 md:w-24 md:h-32 lg:w-28 lg:h-36 opacity-30">
              ...
              <h3 className="font-['Afacad'] font-medium text-[clamp(1.75rem,3vw,3.5rem)] lg:text-[56px] text-[#9059e3] mb-4 lg:mb-6 leading-tight">
            ...
            <div className="bg-[#faefef] border-2 border-[#c63c39] rounded-2xl p-6 md:p-8 lg:p-10 relative overflow-hidden min-h-[300px] lg:min-h-[400px]">
              <div className="absolute right-4 top-4 w-24 h-24 md:w-28 md:h-32 lg:w-32 lg:h-36 opacity-30">
              ...
              <h3 className="font-['Afacad'] font-medium text-[clamp(1.75rem,3vw,3.5rem)] lg:text-[56px] text-[#d46b68] mb-4 lg:mb-6 leading-tight">
          ...
          {/* Partners & Policy Makers Card (Full Width) */}
          <div className="bg-[#edf1fd] border-2 border-[#1b51da] rounded-2xl p-6 md:p-8 lg:p-10 mb-10 md:mb-12 lg:mb-16 relative overflow-hidden">
            <div className="absolute right-4 top-4 w-28 h-24 md:w-40 md:h-32 lg:w-48 lg:h-40 opacity-30">
            ...
            <h3 className="font-['Afacad'] font-medium text-[clamp(1.75rem,3vw,3.5rem)] lg:text-[56px] text-[#3769e6] mb-6 lg:mb-8 leading-tight">
              Partners & Policy Makers
            </h3>
            <div className="max-w-[95%]">
              <p className="font-['Afacad'] text-[clamp(1rem,1.25vw,1.25rem)] lg:text-[20px] text-[#3769e6] leading-relaxed lg:leading-[1.6] mb-6">
              ...
              <p className="font-['Afacad'] text-[clamp(1rem,1.25vw,1.25rem)] lg:text-[20px] text-[#3769e6] leading-relaxed lg:leading-[1.6]">
      ...
      <section className="w-full bg-black py-12 md:py-16 lg:py-20">
        <div className="max-w-[1488px] mx-auto px-4 md:px-8">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16">
            ...
            <LogosMeta />
            <div className="h-[104px] relative w-[328px]">
              <img alt="Partner Logo" className="w-full h-full object-contain" src={imgImage2} />
            </div>
            <div className="relative size-[160px]">
              <img alt="Partner Logo" className="w-full h-full object-contain" src={imgImage4} />
            </div>
          </div>
        </div>
      </section>

      {/* 6 Continents Section */}
      <section className="w-full px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-40 py-12 md:py-16 lg:py-20">
        <div className="max-w-[1488px] mx-auto">
          ...
          <div className="w-full rounded-2xl overflow-hidden mb-10 md:mb-12 lg:mb-16 shadow-xl">
            <img src={imgFrame87} alt="World Map" className="w-full h-auto object-cover" />
          </div>

          <div className="flex flex-col sm:flex-row gap-6 lg:gap-8 justify-center items-center">
            <button className="bg-[#6923d2] text-white px-10 py-4 md:px-12 md:py-5 lg:px-16 lg:py-6 rounded-lg font-['Afacad'] font-medium text-[clamp(1.125rem,1.5vw,1.5rem)] lg:text-[24px] hover:bg-[#5a1db8] transition-colors shadow-lg w-full sm:w-auto inline-block">
              Get Tickets
            </button>
            <button className="bg-[#f9f5ff] border-2 border-[#6941c6] text-[#6941c6] px-10 py-4 md:px-12 md:py-5 lg:px-16 lg:py-6 rounded-lg font-['Afacad'] font-medium text-[clamp(1.125rem,1.5vw,1.5rem)] lg:text-[24px] hover:bg-[#f3edff] transition-colors shadow-lg w-full sm:w-auto inline-block">
              Become a Partner
            </button>
          </div>
        </div>
      ...
      <section className="w-full bg-[#9662e5] px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-40 py-12 md:py-16 lg:py-20 relative overflow-hidden">
        <div className="absolute left-[-130px] bottom-0 h-[312px] w-[274px] opacity-20">
          <img src={imgImage} alt="" className="w-full h-full object-cover" />
        </div>
        <div className="absolute right-[-50px] top-[-55px] h-[312px] w-[274px] opacity-20">
          <img src={imgImage} alt="" className="w-full h-full object-cover" />
        </div>

        <div className="max-w-[1488px] mx-auto relative z-10">
          <h2 className="font-['Afacad'] font-medium text-[clamp(2.5rem,5vw,4.5rem)] lg:text-[72px] text-white tracking-tight text-center mb-12 md:mb-16 lg:mb-20">
            Our Speakers
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-10 md:mb-12 lg:mb-16">
            {/* Speaker 1 */}
            <div className="bg-[#f3eefc] border-2 border-[#6d24db] rounded-2xl overflow-hidden">
              <div className="p-4 lg:p-5">
                <img src={imgFrame96} alt="Alar Karis" className="w-full h-auto rounded-lg" />
              </div>
              <div className="p-4 md:p-6 lg:p-7">
                <h3 className="font-['Afacad'] font-medium text-[clamp(2rem,3vw,3.5rem)] lg:text-[56px] text-[#6923d2] leading-tight">
                  Alar Karis
                </h3>
                <p className="font-['Afacad'] text-[clamp(1rem,1.25vw,1.25rem)] lg:text-[20px] text-[#6923d2] mt-2">
            ...
            <div className="bg-[#f3eefc] border-2 border-[#6d24db] rounded-2xl overflow-hidden">
              <div className="p-4 lg:p-5">
                <img src={imgFrame97} alt="Alex Tsado" className="w-full h-auto rounded-lg" />
              </div>
              <div className="p-4 md:p-6 lg:p-7">
                <h3 className="font-['Afacad'] font-medium text-[clamp(2rem,3vw,3.5rem)] lg:text-[56px] text-[#6923d2] leading-tight">
                  Alex Tsado
            ...
            <div className="bg-[#f3eefc] border-2 border-[#6d24db] rounded-2xl overflow-hidden">
              <div className="p-4 lg:p-5">
                <img src={imgFrame98} alt="Erkki Leego" className="w-full h-auto rounded-lg" />
              </div>
              <div className="p-4 md:p-6 lg:p-7">
                <h3 className="font-['Afacad'] font-medium text-[clamp(2rem,3vw,3.5rem)] lg:text-[56px] text-[#6923d2] leading-tight">
                  Erkki Leego
            ...
            <div className="bg-[#f3eefc] border-2 border-[#6d24db] rounded-2xl overflow-hidden">
              <div className="p-4 lg:p-5">
                <img src={imgFrame99} alt="Kate Kallot" className="w-full h-auto rounded-lg" />
              </div>
              <div className="p-4 md:p-6 lg:p-7">
                <h3 className="font-['Afacad'] font-medium text-[clamp(2rem,3vw,3.5rem)] lg:text-[56px] text-[#6923d2] leading-tight">
                  Kate Kallot
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-40 py-12 md:py-16 lg:py-24">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="font-['Afacad'] font-medium text-[clamp(2rem,4vw,4rem)] lg:text-[64px] text-black tracking-tight mb-12 md:mb-16 lg:mb-20 leading-tight">
          ...
          <div className="flex justify-center items-center gap-4 md:gap-8 lg:gap-12">
            <div className="flex flex-col items-center">
              <p className="font-['Space_Mono'] text-[clamp(4rem,10vw,10rem)] lg:text-[160px] text-[#6923d2] tracking-tight leading-none">
                344
              </p>
              <p className="font-['Orbitron'] text-[clamp(1.5rem,3vw,3rem)] lg:text-[48px] text-[#6923d2] tracking-tight mt-4 lg:mt-6">
                Days
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <p className="font-['Space_Mono'] text-[clamp(4rem,10vw,10rem)] lg:text-[160px] text-[#6923d2] tracking-tight leading-none text-right">
                00
              </p>
              <p className="font-['Orbitron'] text-[clamp(1.5rem,3vw,3rem)] lg:text-[48px] text-[#6923d2] tracking-tight mt-4 lg:mt-6">
                Minutes
